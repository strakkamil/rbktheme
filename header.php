...
<body <?php body_class(); ?>>
  ...
  <header>
    <nav class="main-nav">
      <a class="logo" href="<?php echo esc_url(home_url('/')); ?>" aria-label="Strona główna">
      ...
      <ul class="list">
        ...
        <li><a href="<?php echo esc_url(home_url('/oferta/wesele')); ?>">Oferta</a></li>
        <li><a href="<?php echo esc_url(home_url('/media/zdjecia')); ?>">Media</a></li>
